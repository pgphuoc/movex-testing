...
test.describe(`${MODULE_NAME} — Giao diện (Chưa kiểm thử)`, () => {
  test('RP-UI-001: Trang quản lý cấp phát thay thế phụ tùng tải đúng bố cục', async ({ page }) => {
...
test.describe(`${MODULE_NAME} — Chức năng (Chưa kiểm thử)`, () => {
  test('RP-FN-001: Tạo mới yêu cầu thay thế phụ tùng thành công', async ({ page }) => {
